<%@page import="java.sql.Connection" import="java.sql.PreparedStatement" import="java.sql.ResultSet" import=" java.sql.SQLException" import="java.io.IOException" import="ConnectionSQL.ConnectionFactorySQL" contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="pt-br">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="maincalculo.jsp">Sair</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row" style="margin-top: 2px; background-color: #8acff8;" id="calculo">
            ...
            <div class="col-sm-12 col-xl-4 offset-xl-2 text-center">
                <div class="card card-calculo">
                    <div class="card-body">
                        <h1 class="text-start  text-uppercase">Dados da Conta:</h1>
                        <div class="form-group text-start border border-black rounded info-label">    
                            <p><%   
                                    ...
                                    if("1".equals(vl)){
                                        try {
                                            ...
                                            String dtPf = "Select email_pf,nome_pf,rs_em_conta_pf from pf where email_pf = ?;";
                                            stmtPf = con.prepareStatement(dtPf);
                                            stmtPf.setString(1,Email);
                                            ResultSet rsDtPf = stmtPf.executeQuery();
                                            rsDtPf.next();
                                            String name = rsDtPf.getString(2);
                                            String gain = rsDtPf.getString(3);
                                            rsDtPf.close();
                                            stmtPf.close();
                                            out.println("Nome: " + name+"<br>");
                                            out.println("E-mail: " + Email+"<br>");
                                            out.println("Crédito: R$ " + gain+"<br>");
                                        ...
                                        try {
                                            con = ConnectionFactorySQL.getConnection();  
                                            String dtPf = "Select email_pj,razaosocial_pj,rs_em_conta_pj from pj where email_pj = ?;";
                                            stmtPf = con.prepareStatement(dtPf);
                                            stmtPf.setString(1,Email);
                                            ResultSet rsDtPf = stmtPf.executeQuery();
                                            rsDtPf.next();
                            ...
                            <form id="form-alteracao-cadastro" action="emailServlet" method="POST">
                                <div class="form-group text-start">
                                    <button type="submit" class="btn btn-primary" id="botaoAlterar" value="<%=Email%>" name="btEn"> Alterar
                                        Dados</button></a>
                                </div>
                            </form>
                    </div>
