        ...
        <div class="row" style="margin-top: 2px; background-color: #8acff8;" id="coleta">
            <div class="col-sm-12 col-xl-4">
                ...
                <p style="font-size: 1.5rem;">
                    ...
                    .A coleta é realizada por nós com Vans, a cada semana nós vamos a sua residência/empresa para coletar os residuos orgânicos que
                    foram coletados por você e realizarmos a pesagem de seus residuos para que gere seu lucro.
                </p>
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-calculo" method="POST" action="#">
                            ...
                            <div class="form-group text-start">
                                <label for="email" class="d-inline-block">E-mail: </label>
                                <input class="form-control d-inline-block" type="email" name="email" id="email">
                            </div>
                            <div class="form-group text-start">
                            ...
                            <p><%
                                    ...
                                    if(ps != null) {
                                        ...
                                        String calcb = request.getParameter("data");
                                        LocalDate datenow = LocalDate.now();
                                        String date = datenow.toString();
                                        
                                        if ("1".equals(calcb) || calcb.equals(date)){              
                                            if(alter1 == true && alter2 == false){
                                                out.println("Cliente: " + SendGain.ValidationPF(Email,peso) + "<br>Valor inserido:<br>R$ " + CalBonus.calculatorBPF(peso));
                                            }else{
                                                if(alter1 == false && alter2 == true){
                                                    out.println("Cliente: " + SendGain.ValidationPJ(Email,peso) + "<br>Valor inserido:<br>R$ " + CalBonus.calculatorBPJ(peso));
                                                }
                                            }
                                        }else{
                                            if(alter1 == true && alter2 == false){
                                                out.println("Cliente: " + SendGain.ValidationPF(Email,peso) + "<br>Valor inserido:<br>R$ " + CalBonus.calculatorPF(peso));
                                            }else{
                                                if(alter1 == false && alter2 == true){
                                                    out.println("Cliente: " + SendGain.ValidationPJ(Email,peso) + "<br>Valor inserido:<br>R$ " + CalBonus.calculatorPJ(peso));
                                                }
                                            }
                                        }
                                    }
